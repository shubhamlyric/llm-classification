...
def preprocess_data(df: pl.DataFrame, target_column: str) -> pl.DataFrame:
    """
    Preprocess the data
    """
    ...
    for col in feature_columns + [target_column]:
        text_expr = text_expr + pl.lit(col) + pl.lit("=") + pl.col(col) + pl.lit(", ")
...
def process_data(
    ...
    **kwargs,
    ...
    chunk_size = configs.get("batch_size", 32)
    processed_rows = 0
